...
@include('frontend/default/inc/header')
    <section class="login-section py-5">
     ...
     data-background="{{ uploadedAsset(getSetting('login_banner')) ?? staticAsset('frontend/default/assets/img/banner/banner2.jpg') }}">
</div>
                ...
                <div class="col-lg-5 col-12 bg-white d-flex p-0 tt-login-col shadow">
                    <form class="tt-login-form-wrap p-3 p-md-6 p-lg-6 py-7 w-100" action="{{ route('login') }}" method="POST"
                        ...
                        <!--</div>-->
                        <h4 class="mb-4 h3">
    {{ getSetting('login_title') ?? localize('Welcome back to Pure Chemist.') }}
</h4>
