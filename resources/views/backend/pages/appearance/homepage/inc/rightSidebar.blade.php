...
<li>
    <a href="{{ route('admin.appearance.homepage.secondProductSection') }}"
        class="{{ areActiveRoutes(['admin.appearance.homepage.secondProductSection']) }}">
        {{ localize('Second Product Section') }}
    </a>
</li>
