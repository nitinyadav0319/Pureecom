...
<div class="card mb-4">
    <div class="card-body">
        <h5 class="mb-4">Build Your Box Settings</h5>
        ...
        <div class="form-check mb-3">
            <input class="form-check-input"
                   ...
                   value="1"
                   {{ $category->is_box_category ? 'checked' : '' }}>

            <label class="form-check-label" for="is_box_category">
                Build Your Box Category
            </label>
        </div>

        <div class="mb-3">
            <label class="form-label">Box Limit</label>
            <input type="number"
                   class="form-control"
                   name="box_limit"
                   value="{{ $category->box_limit }}"
                   placeholder="3">
        </div>
