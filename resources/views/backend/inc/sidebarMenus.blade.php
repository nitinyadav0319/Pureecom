...
<!-- @can('vendor_approval')
    ...
    <a href="{{ route('admin.vendors.index') }}" class="side-nav-link">
        ...
        <span class="tt-nav-link-text">Vendors Approuval</span>
    </a>
</li>
@endcan -->
...
<li class="side-nav-item nav-item">
    <a href="{{ route('admin.vendors.list') }}" class="side-nav-link">
        ...
        <span class="tt-nav-link-text">Vendors List</span>
    </a>
</li>
@endif -->
@can('pincodes')
...
@if(config('features.vendor_module_enabled') && auth()->user()->user_type == 'vendor')
