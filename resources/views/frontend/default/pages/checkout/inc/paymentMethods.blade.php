    ...
    <div class="checkout-radio d-flex align-items-center justify-content-between gap-3 bg-white rounded p-4 mt-3">
        <div class="radio-left d-inline-flex align-items-center">
            <div class="theme-radio">
                <input type="radio" name="payment_method" class="cod" id="cod" value="cod" required>
        ...
        <div class="radio-left d-inline-flex align-items-center">
            <div class="theme-radio">
                <input type="radio" name="payment_method" class="cod" id="ccavenue" value="ccavenue" required>
                <span class="custom-radio"></span>
            </div>
            <label for="ccavenue" class="ms-2 h6 mb-0">{{ localize('CCAVENUE') }}</label>
        </div>
