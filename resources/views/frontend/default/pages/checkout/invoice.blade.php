    ...
    <div class="border-end pe-2">
        ...
        @if ($shippingAddress)
            <p class="mb-0">
                ...
                {{ $shippingAddress->country_name ?? '' }} - {{ $shippingAddress->pincode ?? '' }}
            </p>
        @else
            <p class="text-muted mb-0">{{ localize('No shipping address found') }}</p>
        @endif
    </div>
    ...
    <div class="ms-4">
        ...
        @if ($billingAddress)
            <p class="mb-0">
                ...
                {{ $billingAddress->country_name ?? '' }} - {{ $billingAddress->pincode ?? '' }}
            </p>
        @else
            <p class="text-muted mb-0">{{ localize('No billing address found') }}</p>
        @endif
    </div>
</div>
