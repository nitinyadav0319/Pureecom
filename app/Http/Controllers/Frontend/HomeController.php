...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        // ✅ Featured Products (Left + Right)
        $featuredLeftIds = getSetting('featured_products_left') != null ? json_decode(getSetting('featured_products_left')) : [];
        $featuredProductsLeft = \App\Models\Product::whereIn('id', $featuredLeftIds)->isPublished()->get();

        $featuredRightIds = getSetting('featured_products_right') != null ? json_decode(getSetting('featured_products_right')) : [];
        $featuredProductsRight = \App\Models\Product::whereIn('id', $featuredRightIds)->isPublished()->get();
        ...
        return getView('pages.home', [
            ...
            'featuredProductsLeft' => $featuredProductsLeft,
            'featuredProductsRight' => $featuredProductsRight,
            'featuredBanner' => $featuredBanner,
            'featuredBannerLink' => $featuredBannerLink,
        ]);
    }
