...
class VariationValue extends Model
{
    ...
    public function collectLocalization($entity = '', $lang_key = '')
    {
        ...
        return $variation_value_localizations != null && $variation_value_localizations->$entity
            ? $variation_value_localizations->$entity
            : $this->$entity;
    }
    ...
    /**
     * ✅ Relation to parent Variation (Age, Size, Color, etc.)
     */
    ...
    /**
     * ✅ Relation to ProductVariation (through code column)
     */
    public function productVariations()
    {
        return $this->hasMany(ProductVariation::class, 'code', 'id');
    }
}
